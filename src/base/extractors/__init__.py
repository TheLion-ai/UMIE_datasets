...
The extractors extract specific information from the data, such as image IDs, labels, modality IDs, and study IDs.
...
- BaseModalityIdExtractor: Extracts modality IDs.
...
from .modality_id import BaseModalityIdExtractor
