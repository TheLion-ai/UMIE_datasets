...
class StudyIdExtractor(BaseStudyIdExtractor):
    ...
    def _extract(self, img_path: str) -> str:
        study_id_prefix = self._get_study_id_prefix(img_path=img_path)
        image_folder = self._extract_parent_dir(img_path, node=1, basename_only=True)
    ...
    @staticmethod
    def _get_study_id_prefix(img_path: str) -> str:
