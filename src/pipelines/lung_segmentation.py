...
class LungSegmentationPipeline(BasePipeline):
    ...
    def prepare_pipeline(self) -> None:
        ...
        kidney_tumor_encoding = dataset_masks_config.dataset_masks[self.name]["lungs"]
        # Load labels from the labels file
        # self.labels_list = self.load_labels_from_path() # TODO encode 0 as healthy (good: 0) and 1 as tuberculosis: 27
