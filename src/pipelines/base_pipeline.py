...
class DatasetArgs:
    ...
    mask_selector: Optional[str] = None  # prefix of the source mask file names
    image_folder_name: Optional[str] = "Images"  # folder for images
    mask_folder_name: Optional[str] = "Masks"  # folder for masks
