"""Preprocess the Brain Tumor Detection dataset."""
import os
...
def preprocess_brain_tumor_detection(source_path: str, target_path: str) -> None:
    """Preprocess the Brain Tumor Detection dataset.

    This function preprocesses the Brain Tumor Detection dataset. It changes names and directory structure to meet standard.
    Args:
        source_path (str): path to the downloaded dataset. Location of the "Brain Tumor Detection Dataset" folder.
    ...
    labels_dict = {"yes": "Tumor", "no": "good"}

    def get_label_brain_tumor_detection(img_path: str) -> list:
    ...
    params = {
        ...
        "get_label": get_label_brain_tumor_detection,
        "mask_folder_name": "",
    }
