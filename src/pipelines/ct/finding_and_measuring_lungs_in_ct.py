...
from src.preprocessing.add_new_ids_masks import AddNewIdsMasks
...
def preprocess_lungs_ct(source_path: str, target_path: str, masks_path: str):
    ...
    pipeline = Pipeline(
        steps=[
            ...
            ("add_new_ids_masks", AddNewIdsMasks(**params)),
