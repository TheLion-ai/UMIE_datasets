        ...
        def copy_png_masks(self, img_path):
            ...
            if phase_id in self.phases.keys():
                ...
                if len(self.phases.keys()) <= 1:
                    ...
                    new_path = os.path.join(self.target_path, f"{self.dataset_uid}_{self.dataset_name}", self.mask_folder_name, new_file_name)
                    ...
                    for phase_id in self.phases.keys():
                        ...
                        new_path = os.path.join(self.target_path, f"{self.dataset_uid}_{self.dataset_name}", phase_name, self.mask_folder_name, new_file_name)
