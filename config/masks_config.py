...
masks = {
    ...
    "Kidney": Mask(id=1, color=1, radlex_id="RID205", source_names={"KITS23": ["kidney"], "CT-ORG": ["Kidney"]}),
    "Neoplasm": Mask(id=2, color=2, radlex_id="RID3957", source_names={"KITS23": ["kidney tumor"], "Brain_Tumor_Progression": ["Brain tumor"]}),
    ...
    "Lung": Mask(id=5, color=5, radlex_id="RID1301", source_names={"CT-ORG": ["lungs"], "Lung_segmentation_from_Chest_X-Rays": ["Lungs"], "Finding_and_Measuring_Lungs_in_CT_Data": ["lungs"]}),
    ...
    "CalciumScore": Masks(id=12, color=12, radlex_id="RID28808", source_names={"Stanford_COCA": "coronary_artery_calcium"}), 
    "Metastasis": Masks(id=13, color=13, radlex_id="RID5231", source_names={"StanfordBrainMET": "brain_metastasis"}),
} 
