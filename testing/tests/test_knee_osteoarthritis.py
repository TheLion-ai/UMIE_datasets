...
source_path = os.path.join(os.getcwd(), "testing/test_dummy_data/24_Knee_Osteoarthritis/input/Knee_Osteoarthritis")
target_path = os.path.join(os.getcwd(), "testing/test_dummy_data/24_Knee_Osteoarthritis/output")
expected_output_path = os.path.join(os.getcwd(), "testing/test_dummy_data/24_Knee_Osteoarthritis/expected_output")
