...
source_path = os.path.join(
    os.getcwd(), "testing/test_dummy_data/20_Brain_Tumor_Detection/input/archive-3/brain_tumor_dataset"
)
target_path = os.path.join(os.getcwd(), "testing/test_dummy_data/20_Brain_Tumor_Detection/output")
expected_output_path = os.path.join(os.getcwd(), "testing/test_dummy_data/20_Brain_Tumor_Detection/expected_output")
