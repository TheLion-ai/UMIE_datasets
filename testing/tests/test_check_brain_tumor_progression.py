...
source_path = os.path.join(
    os.getcwd(), "testing/test_dummy_data/25_Brain_Tumor_Progression/input/brain_tumor_progression"
)
masks_path = os.path.join(
    os.getcwd(), "testing/test_dummy_data/25_Brain_Tumor_Progression/input/brain_tumor_progression"
)
target_path = os.path.join(os.getcwd(), "testing/test_dummy_data/25_Brain_Tumor_Progression/output")
expected_output_path = os.path.join(os.getcwd(), "testing/test_dummy_data/25_Brain_Tumor_Progression/expected_output")
